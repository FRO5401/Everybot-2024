...
public class Robot extends TimedRobot {
  ...
   * Speeds can be changed as desired and will be set to 0 when performing an auto that does not require the system */
  ...
  public void autonomousInit() {
    ...
    /* Depeding on which auton is selected, speeds for the unwanted subsystems are set to 0 if they are not used for the selected auton
  ...
  public void teleopInit() {
    /* Motors can be set to idle in brake or coast mode.
     * Brake mode effectively shorts the leads of the motor when not running, making it more difficult to turn when not running.
